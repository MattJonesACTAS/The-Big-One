...
const catchupEl = {
  ...
  pages: document.querySelectorAll('.catchup-page'),
...
// Show catchup modal on first load if no saved state
if (!localStorage.getItem('theBigOneState')) {
  document.getElementById('catchupModal').style.display = 'flex';
}
